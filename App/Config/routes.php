...
return [
    ...
    Route::get('/files/add', [FilesController::class, 'add']),
    Route::post('/files/add', [FilesController::class, 'store']),
    Route::get('/files/get/', [FilesController::class, 'show']),
    Route::put('/files/rename/', [FilesController::class, 'rename']),
    Route::delete('/files/remove/', [FilesController::class, 'remove']),
